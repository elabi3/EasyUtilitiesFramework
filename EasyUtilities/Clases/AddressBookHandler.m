...
#import "ManejadorAddressBook.h"
#import <AddressBook/AddressBook.h>
#import "AgendaEntry.h"
#import "Person.h"


static ManejadorAddressBook * instance;

@implementation ManejadorAddressBook

+ (ManejadorAddressBook *) getInstance {
    if (instance == nil) {
        instance = [[ManejadorAddressBook alloc] init];
    }
    return instance;
}
...
-(NSString *) getNameFromPerson: (Person *) person {
    NSString * name;
    name = self.contactNames[person.email];
    if (name) {
        return name;
    }
    name = self.contactNames[person.phone];
    if (name) {
        return name;
    }
